...
namespace MicroserviceEShopProject.CatalogAPI.Data
{
    public class CatalogInitialData : IInitialData
    {
        public async Task Populate(IDocumentStore store, CancellationToken cancellation)
        {
            ...
            if (await session.Query<Models.Product>().AnyAsync(token: cancellation))
                return;

            // Marten Upsert method will cater for existing records
